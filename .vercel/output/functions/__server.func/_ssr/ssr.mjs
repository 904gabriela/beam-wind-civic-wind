...
import { A as resolveManifestCssLink, B as rootRouteId, D as getScriptPreloadAttrs, H as require_react, I as isRedirect, L as isResolvedRedirect, M as executeRewriteInput, N as invariant, O as getStylesheetHref, S as require_jsx_runtime, V as isNotFound, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as _getRenderedMatches, k as resolveManifestAssetLink, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-nKK2KwQo.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DqXMpz5r.mjs").then((n) => n.t),
